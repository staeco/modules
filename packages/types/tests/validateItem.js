...
import validateItem from '../src/validateItem'
import should from 'should'
import badMultiPolygon from './fixtures/bad-multipolygon.json'
...
describe('validateItem', () => {
  ...
  it('validateItem() should return errors on invalid geojson geometry', async () => {
    ...
    should(await validateItem(spec, item)).eql([
      {
        path: [ 'area' ],
        message: 'Not a valid geometry value', // 'Self-intersection',
        value: item.area
      }
    ])
  })
